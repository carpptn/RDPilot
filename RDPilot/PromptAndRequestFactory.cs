internal static partial class RDPilotApplication
{
    ...
    internal static class PromptAndRequestFactory
    {
                ...
                bool usePersistedReasoningContext = true)
            {
                ...
                {
                    userContent.Add(new { type = "input_text", text = "TURN_REFERENCE_IMAGE: stable interaction state from the current visual epoch only; use it for persistent goals, markers, and world elements on the current board." });
